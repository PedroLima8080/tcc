                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <div class="tcc-form-control {{ $errors->has('fone') ? 'tcc-is-invalid' : '' }}">
                            <input id="fone" type="text" name="fone" value="{{ old('fone') ? old('fone') : $perfil['fone'] }}" autocomplete="off"
                                placeholder=" ">
                    ...
                    <div class="col-md-4">
                        <div class="tcc-form-control {{ $errors->has('cep') ? 'tcc-is-invalid' : '' }}">
                            <input id="cep" type="text" name="cep"
                                value="{{ old('cep') ? old('cep') : $perfil['cep'] }}" autocomplete="off"
                                placeholder=" ">
                    ...
                    <div class="col-md-2">
                        <div class="tcc-form-control {{ $errors->has('uf') ? 'tcc-is-invalid' : '' }}">
                            <input id="uf" type="text" name="uf"
                                value="{{ old('uf') ? old('uf') : $perfil['uf'] }}" autocomplete="off"
                                placeholder=" ">
